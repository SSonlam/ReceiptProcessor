...
public interface ReceiptsApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The number of points awarded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = GetPoints200Response.class))
            }),
    ...
    default ResponseEntity<GetPoints200Response> getPoints(
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Returns the ID assigned to the receipt.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ProcessReceipts200Response.class))
            }),
    ...
    default ResponseEntity<ProcessReceipts200Response> processReceipts(
